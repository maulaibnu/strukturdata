...
node *awal_ptr = NULL;
node *posisi; //digunakan untuk sepanjang list
int option = 0;
...
{
	node *temp, *temp2;
	//pointer sementara (temporary pointer)
	...
	{
		temp2 = awal_ptr;
		//node tidal NULL list tidak kosong
		while (temp2->next != NULL)
		{
			temp2 = temp2->next;
			//memindahkan pada next link dalam rotasi
		}
		temp2->next = temp;
	}
}
...
void hapus_tengah_list()
{
	...
	if (awal_ptr != NULL)
	{
		...
		cout<<"Data masih kosong, tidak bisa dihapus dari tengah";
	getc;
}
